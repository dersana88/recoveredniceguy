...
export default function TestimonialDouble({ testimonials }: TestimonialDoubleProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto my-16 px-4 fade-in">
      {testimonials.map((testimonial, index) => (
        <div 
          key={index}
          className={`p-6 md:p-8 rounded-xl border transition-all duration-300 ${
