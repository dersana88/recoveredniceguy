    ...
    <div className="min-h-screen bg-[#0f0f14] flex items-center justify-center px-4 sm:px-6 pt-safe pb-safe">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-400">Get instant access to the Ghost Recovery Protocol</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all pr-12"
